...
cp "${ROOT_DIR}/packaging/nerv" "${STAGE_DIR}/nerv"
...
chmod 755 "${STAGE_DIR}/djonehub" "${STAGE_DIR}/nerv" "${STAGE_DIR}/install" "${STAGE_DIR}/bin/djonehub-macos" "${STAGE_DIR}/lib/libusb-1.0.0.dylib"
